"""Seed development data: creates a test admin and sample businesses."""
...
async def seed():
    ...
    async with async_session_factory() as db:
        ...
        # Create sample roofing business
        business = Business(
            id=uuid.uuid4(),
            ...
            branding={
                ...
                "logo_url": None,
                "welcome_message": "Welcome to Apex Roofing! \U0001f3e0 How can we help you with your roofing needs today?",
            },
        ...
        # Create sample landscaping business
        business2 = Business(
            id=uuid.uuid4(),
            ...
            branding={
                ...
                "logo_url": None,
                "welcome_message": "Hi there! \U0001f33f Welcome to Green Valley Landscaping. How can we help transform your outdoor space?",
            },
        ...
        print("   Admin: admin@inbound-bot.com / admin123")
        print("   Business 1: Apex Roofing Co (slug: apex-roofing)")
        print("   Business 2: Green Valley Landscaping (slug: green-valley)")
